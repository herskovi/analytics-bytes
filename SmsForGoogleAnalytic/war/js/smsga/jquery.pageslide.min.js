...
;(function(b)
		{
			...
			function k(b,a)
			{
				...
				if(!c.is(":visible")&&!h)
				{
					...
					{
						case "left":
							c.css({left:"auto",right:"-"+d+"px"});
							f["margin-left"]="-="+d;g.right="+="+d;
							break;
						default:
							c.css({left:"-"+d+"px",right:"auto"}),f["margin-left"]="+="+d,g.left="+="+d}l.animate(f,a);
				...
				b.pageslide=function(e)
				{
					...
					?
							b.pageslide.close(function(){j(a.href,a.iframe);k(a.direction,a.speed)})
					:
				...
				};//end function b.pageslide.close
				c.click(function(b)
						{
							b.stopPropagation()
						});
