		...
		<div class="row toppadding">
        	...
        	<div class="col-md-4">
            	 <img src="/analyticsbytes/images/step1.png" class="img-circle" alt="Step 1">
            	 	...
            	 	<div class="col-lg-12">
						<blockquote>
							<p><b>Your mobile number where you wish to recieve your FREE text messages</b></p>
						</blockquote>
					</div>
        	</div>
       	...
       	<div class="row">
       		<div class="form-wrapper">
       		 <form name="mobileSelectionWizardForm" action="/mobilewizard" method="post" class="form-horizontal login-form">
            	 ...
            	 <div class="col-lg-12">
       				...
       				<div class="form-group">
							...
							<div class="col-sm-4">
								...
								<input type="tel" id="demo" class="form-control" name="mobile_number" placeholder="Text Messages will be sent to this number" tabindex=2>
