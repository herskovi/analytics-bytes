 ...
 * May 5, 2014
 */
public interface CredentialConsts  extends GeneralConsts
{
	public static  String TOKEN = "token"; 
	//public static  String CLIENT_ID = "350054109263-8rvc4mcjfhhs8hv1h7or1h908hquqs23.apps.googleusercontent.com";
	public static  String CLIENT_ID = "711375724497-o0eal8kbfpgf2jvruifi69k6u4nbisi7.apps.googleusercontent.com";
	//public static  String CLIENT_SECRET = "YGQDbwIKDj0hxFjb3Pm4xGLa";
	public static  String CLIENT_SECRET = "hgf4KloF3XfHEkIbkVPmOMNk";
	public static  String REDIRECT_URI = "http%3A%2F%2Fanalyticsbyte.appspot.com%2Fsmsforgoogleanalyticcallbacksample";
	...
	public static  String GOOGLE_OAUTH_REDIERCET_URL_IS_GAE_HOST = "redirect_uri=http%3A%2F%2Fanalyticsbyte.appspot.com%2Fsmsforgoogleanalyticcallbacksample";
