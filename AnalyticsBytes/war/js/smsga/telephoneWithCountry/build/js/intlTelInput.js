     ...
     ********************/
        ...
        _appendListItems: function(countries, className) {
            ...
            for (var i = 0; i < countries.length; i++) {
                ...
                tmp += "<span class='dial-code'>+" + c.dialCode + spaceChar + "</span>";
                // close the list item
                tmp += "</li>";
            }
                ...
                if (e.which == keys.ENTER) {} else if (that.options.autoFormat) {
                    ...
                    if (!that.options.nationalMode) {
                        ...
                        if (val.substr(0, 1) != "+") {
                            ...
                            var newCursorPos = that.isGoodBrowser ? input.selectionStart + 2 : 0;//Moshe - Trying to add two spaces
        ...
        _selectFlag: function(countryCode) {
            ...
            this.selectedFlagInner.parent().attr("id", "Country" + countryCode); //Moshe h -Adding Country Code as ID.
            this.selectedFlagInner.parent().attr("name", "Country" + countryCode); //Moshe h -Adding Country Code as ID.
