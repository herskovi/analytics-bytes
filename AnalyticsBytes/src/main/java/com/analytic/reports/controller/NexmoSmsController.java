...
public class NexmoSmsController extends SMSFlowController
{
	...
	public   List<NameValuePair> populateSMSParameters() {
		...
		nvps.add(new BasicNameValuePair(NexmoConsts.SMS_VENDOR_PARAM_NAME_SENDER_ID, NexmoConsts.SMS_VENDOR_PARAM_VALUE_SENDER_ID));
		//FIXME - Check if it supports utf-8
