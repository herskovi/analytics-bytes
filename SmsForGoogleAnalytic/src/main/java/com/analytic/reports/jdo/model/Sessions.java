...
public class Sessions  implements IEntity
{
	@PrimaryKey
    @Persistent
	 ...
	 */
	public Sessions(String uniqueAccountNumber, String plan,String userId, String name, String companyName,
	...
	public Sessions(String uniqueAccountNumber,String userId,  String countryCode, String telephoneNumber) 
	{
		super();
		this.uniqueAccountNumber=uniqueAccountNumber;
		this.userId = userId;
