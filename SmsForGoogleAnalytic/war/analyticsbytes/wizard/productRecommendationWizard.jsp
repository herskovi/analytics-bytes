				...
				<div class="container whitediv toppadding">
					...
					<div class="row">
						<div class="form-wrapper">
							<form name="productRecommendationEmailSelectionWizardForm"
								action="productrecommendationemailselectionwizard" method="post"
								class="form-horizontal login-form">
								<input id="uniqueAccountNumber" name="uniqueAccountNumber"
									type="hidden" value='${uniqueAccountNumber}' /> <br> <br>
								<br> <br> <br> <br>
								...
								<div class="form-group">
									<label for="mobile" class="col-sm-4 control-label">Email<span
									...
									<div class="col-sm-4">
										...
										<span id="email_address_error" class="error inline-error"
											...
											address.</span> <span class="help-block"display:none"> *
											Make sure you are using a Google Analytics account</span>
									</div>
								</div>
								<div class="container">

									<div class="form-group">
										<label for="mobile" class="col-sm-4 control-label">Start Date<span class="required">*</span>
										</label>
										<div class="col-sm-4">
										
										
											<div class='input-group date' id="startDateForGoogleAnalytics">
													<input type='text' id="startDateForGoogleAnalytics" name="startDateForGoogleAnalytics"  class="form-control" /> 
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<button type="submit" class="btn btn-success btn-lg btn-block" role="button">
											Upload Latest data From Analytics Account</button>
									</div>
								</div>
							</form>
						</div>
...
-->
	...
	<script type="text/javascript" src="../js/smsga/jquery.min.js"></script>
	<script src="../js/smsga/jquery.pageslide.min.js"
		type="text/javascript"></script>
	<script src="../js/smsga/jquery.flexslider-min.js"
		type="text/javascript"></script>
		<script type="text/javascript" src="/js/smsga/modernizr.custom.10128.js"></script> 
	...
	<script type="text/javascript"
		src="/analyticsbytes/js/wizard/mobileSelectionWizard.js"></script>
