	...
	<div class="row-fluid">
		...
		<div class="form-wrapper">
				...
				<div class="control-group row-fluid">
					...
					<div class="controls">
						<input  class="input-xxlarge" id="username" name="username" placeholder="Enter your email..."  title="Enter your Email" type="text" value="" placeholder="Enter your email...">
					</div>
				</div>
				<div class="control-group"> 
					<label class="control-label">Password <span class="required">*</span></label>
					<div class="controls">
						<input  class="input-xxlarge" id="j_password" name="j_password" placeholder="Enter your password..."  title="Enter your Password" type="password" value="" placeholder="Enter your password...">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label"></label>
					<div class="controls">
						<label for="remember"><input type="checkbox" value="remember-me" id="remember_me"> Remember me</label>
					</div>
				</div>
...
<script type="text/javascript" src="/js/kit/jquery.url.js?v=184"></script>
