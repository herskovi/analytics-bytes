...
<!--  <link rel="stylesheet" type="text/css" media="all" href="./style/smsga/mobileScreen.css">  -->
	...
	<div class="feature alt-bg">
		<div class="row-fluid">
			<div id="sides"> 
				...
				<div id="left" class="form-wrapper"> 	
							...
							<div class="control-row">
								...
								<div class="controls">
									<div id="timepickerDIV">
										...
										<select id="timeZoneDropdown" name="timeZoneDropdown" class="input-xlarge" >
