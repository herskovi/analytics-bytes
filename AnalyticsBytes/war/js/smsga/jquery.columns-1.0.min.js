 ...
 */if(!window.console)var console=
 ...
 (function(e)
	 ...
	 t.prototype=
	 {
			 table:null,search:null,schema:null,sortBy:null,showRows:[5,10,25,50],
			 reverse:!1,size:5,page:1,pages:1,query:null,range:null,total:null,master:null,
			 templates:{table:'<div class="{{columns_table_class}}"></div>',
				 ...
				 sort:function()
				 {
					 function n(e,n,r)
					 {
						 ...
						 return function(i,s){
							 ...
							 {
								 i=new Date(i);i=Date.parse(i);s=new Date(s);s=Date.parse(s)
