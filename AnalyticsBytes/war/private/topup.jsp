...
<input type="image" src="http://www.paypal.com/en_US/i/btn/x-click-but01.gif" name="submit" alt="Make payments with PayPal - it's fast, free and secure!">
 ...
 -->
				...
				<!--  <form id="topup_form" class="form-horizontal" action="https://www.paypal.com/il/cgi-bin/webscr" method="post">  -->   	
							...
							<input type="hidden" name="currency_code" value="USD">
							<input type="hidden" name="return" value="http://localhost:8888/private/orderConfirmation">
							<input type="hidden" name="rm" value="2">
							<input type="hidden" name="cancelUrl" value="http://dailyreportbysmsforga.appspot.com/private/orderWasCancel'">
							...
							<div class="control-group">
								...
								<select id="amount" name="amount">
							           ...
							           <option value="0.02">0.02$ - Trial</option> 
							           <option value="5.99">5.99$ - 1 Month</option>
							           <option value="9.99">9.99$ - 4 Motnts</option>
							           <option value="19.99">19.99$ - 1 year </option>														           			
								</select>	
								</div>
							</div>
