...
<div class="hero-unit">
	<h1>Only 5$ per Month per User</h1>
	<p class="lead">Get your cutomized analytics data before your first coffee.</p>
			<p><a class="btn" href="/register">Try it for Free</a></p>
</div>
     
	<div id="country-currency">
		<div class="container-fluid">
					<span>5$ per month per user</span>
						<p class="hvp_message">Need more than 100 people will receive analytics data in your organization? <a href="#hvp_form">Contact us</a> for High Volume Pricing</p>
		</div>	
	</div><!-- / container-fluid --> 
	</div>	
	<!-- / country-currency -->
...
<div class="feature centered">
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span4">
				<div class="highlight-icon"><span class="middle-men"></span></div>
				<h3> Stop login to analytics account</h3>
				<p class="last tight">Make sure that Marketing, Sales and Business Development received same analytics data online from your Google Analytics</p>
			</div>
			<div class="span4">
				<div class="highlight-icon"><span class="lock-in"></span></div>
				<h3>No lock-in</h3>
				<p class="last tight">Analytics Bytes earns your business everyday.  We won't force you into any contract--just sign up and get started.</p>
			</div>
			<div class="span4">
				<div class="highlight-icon"><span class="quality"></span></div>
				<h3>Uncompromised quality</h3>
				<p class="last tight">We work tirelessly to give you the best deliverability in the industry.  
									Forget asking your marketing if we met our daily targets  and just focus on your business.</p>
			</div>
		</div>
...
<script type="text/javascript">
  ...
  _gaq.push(['_setDomainName', 'analyticsbytes.com']);
