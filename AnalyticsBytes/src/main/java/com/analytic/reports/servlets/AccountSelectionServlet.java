...
import main.java.com.anaytic.reports.datatypes.AccountDT;
...
//		String profileDropdown = req.getParameter("profileDD");
		...
		cust.setUserSts("1");//User approved GA but is not active till user will click on confirmation mail.
		...
		sendConfirmationEmailToCustomer(userId);
