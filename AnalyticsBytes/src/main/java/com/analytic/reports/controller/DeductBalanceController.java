 ...
 * Aug 14, 2014
 */
public class DeductBalanceController implements IBalanceController 
{
	...
	public DeductBalanceController(Customer cust) 
	{
		super();
		this.cust = cust;
	}
	 ...
	 * @param balance
	 */
	public DeductBalanceController(Customer cust, String amount) {
		super();
		this.cust = cust;
		this.amount = amount;
	}
