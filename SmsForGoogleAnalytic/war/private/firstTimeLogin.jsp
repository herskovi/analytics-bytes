...
<!--TODO -  Remove Balance from thank you page 			
 ...
 -->
 		...
 		<div class="nav_link">
			<a href="#nav" class="open">
				<span class="main_mobile_menu_toggle">&#9776;</span>
			</a>
		</div>
</div>
...
-->
	...
	<div class="get-started dashboard-body clearfix centered container-fluid" id="welcome_message" style="display: block;">
			...
			<h2 class="title">Welcome to Analytics Bytes</h2>
			...
			<div id="getSmsNowParagraph" style="display: block;"> 
				<p>Click on "GET SMS NOW" to verify that all details were entered properly</p>
			</div>
			...
			<div id="sms-recieved-container" style="display: none;">
					<!-- <form id="smsRecievedForm" class="form-horizontal" novalidate="novalidate"> -->
			 
					<div id="didYouRecieveTheSMSQuestion" class="control-group">
						<h1 class="title">Did you recieve the SMS?</h1>
					</div>
						<input type="hidden" id="userid" name="userid" value='${userId}'> 
						
					<div id="yesNoButtonsDivForSMSConfirmation" class="control-group">
						
						<span>
							<!--  <input class="btnConfirmationYes" type="submit" id="smsRecieved" name="smsRecieved" value="Yes"> -->
							<button id="btnConfirmationYes" class="btnConfirmationYes" type="text">Yes</button>							
						</span>
						<td></td>
						<span>
							<button class="btnConfirmationNo" id="btnConfirmationNo" type="text">No</button>						
						</span>
						<div id="spinnerForConfirmationButton" style="display: none;">
							<img src="/images-new/smsga/spinner-icon.gif" alt="Wait" />
						</div>
					</div>	
					<div id="smileyForBtnConfirmationYes" style="display: none;">
							<img src="/images-new/smsga/smiley.jpeg" alt="Wait" />
					</div>
					<div id="sadEmoticonForBtnConfirmationNo" style="display: none;">
						<p>	We apologize for the inconvenience! A customer service rep will be reaching out to you as soon as possible</p>	
						<img src="/images-new/smsga/sadEmoticon.jpg" alt="Wait" />
					</div>
					<!--  </form> -->			
				</div>
