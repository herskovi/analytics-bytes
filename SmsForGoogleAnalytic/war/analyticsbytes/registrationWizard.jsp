			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<h1>
							<span class="hero-title">Let&#39s get you up some Analytics Bytes</span>
						</h1>

						<p class="lead">Connecting is easy as 1, 2, 3 !!!</p> 
						<br />
    	...
    	<div class="row">
        	<div class="col-xs-4">
        		<span class="col-md-4 col-md-offset-4">
        	    	Your mobile number where you wish to recieve your FREE text messages 
        		</span>
    		</div>
        	<div class="col-xs-4">
        		<span class="col-md-4 col-md-offset-4">
        	    	Connect your Google Analytics Account and select your Website&#47App Analytics   
        		</span> 
        	</div>
        	<div class="col-xs-4">
        		<span class="col-md-4 col-md-offset-4">
        	    	Start recieving your Google Analytics results: Sessions, Users, Conversions! 
        		</span> 
        	</div>
        </div>
         -->	
