...
<div id="api_settings" class="api-settings" style="display: none;"></div>
 ...
 <div class="container-fluid">
  ...
  <div class="get-started dashboard-body clearfix centered container-fluid" id="welcome_message" style="display: block;">
	  ...
	  <h2 class="title">Thanks for purchasing at Analytics Bytes, let&rsquo;s get started.</h2> 
	  ...
	  <p>Here you can configure your account, access traffic analytics, top-up and add phone numbers.</p>
		  ...
		  <div class="row-fluid">
			  <div class="span">
			  	Your Account has beed credits with additional ${topUpAmount} $
		  	  </div>
		  </div>
		<!--   <div class="row-fluid">
			  <div class="span">
