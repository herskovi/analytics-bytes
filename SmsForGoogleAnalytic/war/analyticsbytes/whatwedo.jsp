...
<html lang="en">
   <head>
    ...
    <link href="/analyticsbytes/css/jumbotron.css" rel="stylesheet"> <!-- Oran Added -->
    <link href="/analyticsbytes/css/analyticsbytes.css"  rel="stylesheet">         <!-- Oran Added -->
...
'//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
    ...
    <!-- Main jumbotron for a primary marketing message or call to action -->
          <div class="rapper graydiv toppadding"> <!-- Oran Added  - main gray div--> 
                ...
                <div class="container whitediv"> <!-- Oran Added - secondery white div -->
    ...
    <script src="/analyticsbytes/bootstrap/dist/js/bootstrap.min.js"></script>
