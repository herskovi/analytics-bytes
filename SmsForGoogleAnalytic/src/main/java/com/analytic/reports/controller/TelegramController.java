...
import main.java.com.analytic.reports.utils.consts.TelegramConsts;
 ...
 * May 21, 2014
 */
public class TelegramController extends SMSFlowController
{
	 ...
	 */
	public TelegramController(String telephoneNumber) 
	{
		super(null,telephoneNumber);
	}
	...
	{
		return TelegramConsts.TELEGRAM_GATEWAY_URL;
	}
