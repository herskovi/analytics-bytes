...
public class PaypalFunctionsUtils {
	...
	public PaypalFunctionsUtils(boolean isLocalMode) {// lhuynh - Actions to be Done on init of this
								// class
	...
	public HashMap setExpressCheckout(String paymentAmount, String returnURL,
		...
		Object ackObj = nvp.get("ACK");
		String strAck = null;
		if (ackObj != null)
		{
			strAck = ackObj.toString();
		}
