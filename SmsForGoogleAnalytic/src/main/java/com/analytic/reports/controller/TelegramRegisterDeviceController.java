 ...
 * Jul 21, 2014
 */
public class TelegramRegisterDeviceController extends BaseController
{
	private String telephoneNumber = null;
	private boolean isLocalMode = false;	
	private IResponse telegramRegisterDeviceControllerResponse = newResponse();
	private static final Logger log = Logger.getLogger(DailySmsServlet.class.getName());



	public TelegramRegisterDeviceController(String email, boolean isLocalMode)
	{
	...
	public void execute() throws Exception
	{
		...
		try
		{
			IController smsFlowController = getController(telephoneNumber);							
	...
	private IController getController(String telephoneNumber) 
	{
		return new TelegramController(telephoneNumber);
	}
	...
	{
		return this.telegramRegisterDeviceControllerResponse;		
	}
	...
	{
		telegramRegisterDeviceControllerResponse.setMessage(textMessage);	
	}
